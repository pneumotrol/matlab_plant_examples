function plot_bode()
    ...
    [mag_sysc,phase_sysc,w_vec] = bode(ss(sysc.A,sysc.B,sysc.C,sysc.D),{1e-1,1e2});
    ...
    figure("Name","cart_pole bode plot (from f to q)");
    ...
    figure("Name","mass_damper_spring_2DOF bode plot (from f to theta)");
